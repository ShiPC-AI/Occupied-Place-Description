#ifndef _LIDAR_200_LINEFIT_BIN_H_SEGMENT_H_
#define _LIDAR_200_LINEFIT_BIN_H_SEGMENT_H_

#include <list>
#include <map>
#include "offline_mapping/linefit/bin.h"
...
#endif //_LIDAR_200_LINEFIT_BIN_H_SEGMENT_H_
